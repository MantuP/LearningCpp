...
def readFiles():
	...
	l_FileNameOfThePtr_AMC    = Utility.getConfValueUsingLevel('FileNameOfThePtr','AMC')
	...
	for l_file in os.listdir():
		if l_file.endswith(".xlsx"):
			...
			if "_" in l_file:
				...
				elif(l_subStrFileName == l_FileNameOfThePtr_AMC ):
					Amc_AM1_Manipulation.readAndManipulation(l_file,l_uploudPrefix,l_uploudExtension,l_readFilePath,l_errorFilePath,l_upoladededPath,l_bkp_downloadedPath,l_OutPutColumnsHeader,l_OutPutColumnsHeaderDelm)
