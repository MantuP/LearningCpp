#ifndef PM_Partners_RoamingIdentifierCache_H
#define PM_Partners_RoamingIdentifierCache_H
...
class PM_Partners_RoamingIdentifierCache : public ABL_DataCache
{
public:
	PM_Partners_RoamingIdentifierCache(){}
	PM_Partners_RoamingIdentifierCache(ABL_Date pd_Valid_From,ABL_Date pd_Valid_To,ABL_String ps_TransferType="" ,ABL_String ps_PartnerCode="", ABL_String ps_POICode="",ABL_String ps_TrunkCode="",ABL_String ps_TobeRated="",ABL_String ps_RateZone="",ABL_String ps_OperationalDomain="", int  pn_RecordingEntityType = 0,ABL_String ps_AppOwner="",ABL_String ps_AllowIcTraffic="",int  pn_PiLen= 0) : md_Valid_From(pd_Valid_From),md_Valid_To(pd_Valid_To), ms_TransferType(ps_TransferType),ms_PartnerCode(ps_PartnerCode), ms_POICode(ps_POICode), ms_TrunkCode(ps_TrunkCode) , ms_TobeRated(ps_TobeRated), ms_RateZone(ps_RateZone),  ms_OperationalDomain(ps_OperationalDomain), mn_RecordingEntityType(pn_RecordingEntityType),ms_AppOwner(ps_AppOwner),ms_AllowIcTraffic(ps_AllowIcTraffic),mn_PiLen(pn_PiLen)  {}	
	PM_Partners_RoamingIdentifierCache(const PM_Partners_RoamingIdentifierCache& p_copyObject);
	virtual ~PM_Partners_RoamingIdentifierCache(){}
	virtual Base_Registry* mb_clone() { return ((Base_Registry*) new PM_Partners_RoamingIdentifierCache()); }
...
extern "C" {EXPORT Base_Registry* gb_getPM_Partners_RoamingIdentifierCache();}
