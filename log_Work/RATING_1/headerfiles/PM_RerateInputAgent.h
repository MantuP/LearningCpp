#ifndef PM_RerateInputAgent_H
#define PM_RerateInputAgent_H
...
class PM_RerateInputAgent : public ABL_Process
{
public:
	PM_RerateInputAgent();
	virtual ~PM_RerateInputAgent();
	PM_RerateInputAgent(const PM_RerateInputAgent&);
...
extern "C" {EXPORT Base_Registry* gb_getPM_RerateInputAgent();}
