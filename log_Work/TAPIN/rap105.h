 ...
 *    rap105.h
 *
 *    "RAP-0105" ASN.1 module C type definitions and prototypes
 *
 *    This .h file was generated by snacc on Mon Apr  9 15:32:16 2012
 *
...
typedef FileSequenceNumber LastSeqNumber; /* [APPLICATION 555] IMPLICIT FileSequenceNumber */

#define BEncLastSeqNumberContent BEncFileSequenceNumberContent

#define BDecLastSeqNumberContent BDecFileSequenceNumberContent

#define PrintLastSeqNumber PrintFileSequenceNumber

#define FreeLastSeqNumber FreeFileSequenceNumber 
...
typedef AbsoluteAmount TotalSevereReturnTax; /* [APPLICATION 553] IMPLICIT AbsoluteAmount */

#define BEncTotalSevereReturnTaxContent BEncAbsoluteAmountContent

#define BDecTotalSevereReturnTaxContent BDecAbsoluteAmountContent

#define PrintTotalSevereReturnTax PrintAbsoluteAmount

#define FreeTotalSevereReturnTax FreeAbsoluteAmount 
...
typedef struct StopReturn /* [APPLICATION 554] IMPLICIT SEQUENCE */
{
    LastSeqNumber lastSeqNumber; /* LastSeqNumber */
    OperatorSpecList* operatorSpecList; /* OperatorSpecList OPTIONAL */
} StopReturn;

AsnLen BEncStopReturnContent PROTO ((BUF_TYPE b, StopReturn *v));

void BDecStopReturnContent PROTO ((BUF_TYPE b, AsnTag tagId0, AsnLen elmtLen0, StopReturn *v, AsnLen *bytesDecoded, ENV_TYPE env));


void PrintStopReturn PROTO ((FILE* f, StopReturn *v, unsigned short int indent));
void FreeStopReturn PROTO ((StopReturn *v));
...
typedef struct RapAuditControlInfo /* [APPLICATION 541] IMPLICIT SEQUENCE */
{
    ...
    OperatorSpecList* operatorSpecList; /* OperatorSpecList OPTIONAL */
    TotalSevereReturnTax* totalSevereReturnTax; /* TotalSevereReturnTax OPTIONAL */
} RapAuditControlInfo;
...
typedef struct ReturnDetail /* CHOICE */
{
    ...
    {
    struct StopReturn* stopReturn; /* StopReturn */
...
#endif /* conditional include of rap105.h */
