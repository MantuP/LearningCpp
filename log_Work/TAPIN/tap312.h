 ...
 *    tap312.h
 *
 *    "TAP-0312" ASN.1 module C type definitions and prototypes
 *
 *    This .h file was generated by snacc on Thu Jun 20 18:26:18 2013
 *
...
typedef AsnReal ChargeableUnits; /* [APPLICATION 65] IMPLICIT INTEGER */

#define BEncChargeableUnitsContent BEncAsnRealContent

#define BDecChargeableUnitsContent BDecAsnRealContent

#define PrintChargeableUnits PrintAsnReal

#define FreeChargeableUnits FreeAsnReal
...
typedef AsnReal ChargedUnits; /* [APPLICATION 68] IMPLICIT INTEGER */

#define BEncChargedUnitsContent BEncAsnRealContent

#define BDecChargedUnitsContent BDecAsnRealContent

#define PrintChargedUnits PrintAsnReal

#define FreeChargedUnits FreeAsnReal
...
typedef AsnReal ChargingId; /* [APPLICATION 26] IMPLICIT INTEGER */

#define BEncChargingIdContent BEncAsnRealContent

#define BDecChargingIdContent BDecAsnRealContent

#define PrintChargingId PrintAsnReal

#define FreeChargingId FreeAsnReal
...
typedef AsnReal DataVolume; /* INTEGER */

#define BEncDataVolumeContent BEncAsnRealContent

#define BDecDataVolumeContent BDecAsnRealContent

#define PrintDataVolume PrintAsnReal

#define FreeDataVolume FreeAsnReal
...
typedef AsnInt ElementType; /* [APPLICATION 438] IMPLICIT INTEGER */

#define BEncElementTypeContent BEncAsnIntContent

#define BDecElementTypeContent BDecAsnIntContent

#define PrintElementType PrintAsnInt

#define FreeElementType FreeAsnInt 
...
typedef AsnInt MessagingEventService; /* [APPLICATION 439] IMPLICIT INTEGER */

#define BEncMessagingEventServiceContent BEncAsnIntContent

#define BDecMessagingEventServiceContent BDecAsnIntContent

#define PrintMessagingEventService PrintAsnInt

#define FreeMessagingEventService FreeAsnInt 




typedef AsnInt MobileSessionService; /* [APPLICATION 440] IMPLICIT INTEGER */

#define BEncMobileSessionServiceContent BEncAsnIntContent

#define BDecMobileSessionServiceContent BDecAsnIntContent

#define PrintMobileSessionService PrintAsnInt

#define FreeMobileSessionService FreeAsnInt 
...
typedef AsciiString EventReference; /* [APPLICATION 435] IMPLICIT AsciiString */

#define BEncEventReferenceContent BEncAsciiStringContent

#define BDecEventReferenceContent BDecAsciiStringContent

#define PrintEventReference PrintAsciiString

#define FreeEventReference FreeAsciiString 
...
typedef AsnReal DataVolumeIncoming; /* [APPLICATION 250] IMPLICIT DataVolume */

#define BEncDataVolumeIncomingContent BEncAsnRealContent

#define BDecDataVolumeIncomingContent BDecAsnRealContent

#define PrintDataVolumeIncoming PrintAsnReal

#define FreeDataVolumeIncoming FreeAsnReal


typedef AsnReal DataVolumeOutgoing; /* [APPLICATION 251] IMPLICIT DataVolume */

#define BEncDataVolumeOutgoingContent BEncAsnRealContent

#define BDecDataVolumeOutgoingContent BDecAsnRealContent

#define PrintDataVolumeOutgoing PrintAsnReal

#define FreeDataVolumeOutgoing FreeAsnReal
...
typedef AsciiString ElementId; /* [APPLICATION 437] IMPLICIT AsciiString */

#define BEncElementIdContent BEncAsciiStringContent

#define BDecElementIdContent BDecAsciiStringContent

#define PrintElementId PrintAsciiString

#define FreeElementId FreeAsciiString 
...
typedef struct NetworkElement /* [APPLICATION 441] IMPLICIT SEQUENCE */
{
    ElementType* elementType; /* ElementType OPTIONAL */
    ElementId elementId; /* ElementId OPTIONAL */
} NetworkElement;

AsnLen BEncNetworkElementContent PROTO ((BUF_TYPE b, NetworkElement *v));

void BDecNetworkElementContent PROTO ((BUF_TYPE b, AsnTag tagId0, AsnLen elmtLen0, NetworkElement *v, AsnLen *bytesDecoded, ENV_TYPE env));


void PrintNetworkElement PROTO ((FILE* f, NetworkElement *v, unsigned short int indent));
void FreeNetworkElement PROTO ((NetworkElement *v));





typedef AsnList NetworkElementList; /* [APPLICATION 442] IMPLICIT SEQUENCE OF NetworkElement */

AsnLen BEncNetworkElementListContent PROTO ((BUF_TYPE b, NetworkElementList *v));

void BDecNetworkElementListContent PROTO ((BUF_TYPE b, AsnTag tagId0, AsnLen elmtLen0, NetworkElementList *v, AsnLen *bytesDecoded, ENV_TYPE env));


void PrintNetworkElementList PROTO ((FILE* f, NetworkElementList *v, unsigned short int indent));
void FreeNetworkElementList PROTO ((NetworkElementList *v));
...
typedef AddressStringDigits NonChargedPartyNumber; /* [APPLICATION 444] IMPLICIT AddressStringDigits */

#define BEncNonChargedPartyNumberContent BEncAddressStringDigitsContent

#define BDecNonChargedPartyNumberContent BDecAddressStringDigitsContent

#define PrintNonChargedPartyNumber PrintAddressStringDigits

#define FreeNonChargedPartyNumber FreeAddressStringDigits 




typedef AsciiString NonChargedPublicUserId; /* [APPLICATION 445] IMPLICIT AsciiString */

#define BEncNonChargedPublicUserIdContent BEncAsciiStringContent

#define BDecNonChargedPublicUserIdContent BDecAsciiStringContent

#define PrintNonChargedPublicUserId PrintAsciiString

#define FreeNonChargedPublicUserId FreeAsciiString 
...
typedef AsciiString PublicUserId; /* [APPLICATION 446] IMPLICIT AsciiString */

#define BEncPublicUserIdContent BEncAsciiStringContent

#define BDecPublicUserIdContent BDecAsciiStringContent

#define PrintPublicUserId PrintAsciiString

#define FreePublicUserId FreeAsciiString 
...
/*Commented by Anusha for fix Jira Id: DEFECT-14415 
...
/*Added by Anusha for fix Jira Id : DEFECT-14415*/
typedef AsnReal TotalCharge; /* [APPLICATION 415] IMPLICIT REAL */

#define BEncTotalChargeContent BEncAsnRealContent

#define BDecTotalChargeContent BDecAsnRealContent

#define PrintTotalCharge PrintAsnReal

#define FreeTotalCharge FreeAsnReal 
/*Modification end by Anusah*/
...
typedef AsnReal TotalDataVolume; /* [APPLICATION 343] IMPLICIT DataVolume */

#define BEncTotalDataVolumeContent BEncAsnRealContent

#define BDecTotalDataVolumeContent BDecAsnRealContent

#define PrintTotalDataVolume PrintAsnReal

#define FreeTotalDataVolume FreeAsnReal
...
/*Commented by Anusha for Jir -id fix : DEFECT-14415
...
/*Added by Anusha for fix Jira id : DEFECT-14415*/
typedef AsnReal TotalTaxValue; /*[APPLICATION 226] IMPLICIT AbsoluteAmount*/

#define BEncTotalTaxValueContent BEncAsnRealContent

#define BDecTotalTaxValueContent BDecAsnRealContent

#define PrintTotalTaxValue PrintAsnReal

#define FreeTotalTaxValue FreeAsnReal

/*Modification end by Anusha*/
...
typedef struct NonChargedParty /* [APPLICATION 443] IMPLICIT SEQUENCE */
{
    NonChargedPartyNumber nonChargedPartyNumber; /* NonChargedPartyNumber OPTIONAL */
    NonChargedPublicUserId nonChargedPublicUserId; /* NonChargedPublicUserId OPTIONAL */
} NonChargedParty;

AsnLen BEncNonChargedPartyContent PROTO ((BUF_TYPE b, NonChargedParty *v));

void BDecNonChargedPartyContent PROTO ((BUF_TYPE b, AsnTag tagId0, AsnLen elmtLen0, NonChargedParty *v, AsnLen *bytesDecoded, ENV_TYPE env));


void PrintNonChargedParty PROTO ((FILE* f, NonChargedParty *v, unsigned short int indent));
void FreeNonChargedParty PROTO ((NonChargedParty *v));
...
typedef struct DateTime ServiceStartTimestamp; /* [APPLICATION 447] IMPLICIT DateTime */

#define BEncServiceStartTimestampContent BEncDateTimeContent

#define BDecServiceStartTimestampContent BDecDateTimeContent

#define PrintServiceStartTimestamp PrintDateTime

#define FreeServiceStartTimestamp FreeDateTime 
...
typedef struct ChargedParty /* [APPLICATION 436] IMPLICIT SEQUENCE */
{
    Imsi imsi; /* Imsi OPTIONAL */
    Msisdn msisdn; /* Msisdn OPTIONAL */
    PublicUserId publicUserId; /* PublicUserId OPTIONAL */
    HomeBid homeBid; /* HomeBid OPTIONAL */
    HomeLocationDescription homeLocationDescription; /* HomeLocationDescription OPTIONAL */
    Imei imei; /* Imei OPTIONAL */
} ChargedParty;

AsnLen BEncChargedPartyContent PROTO ((BUF_TYPE b, ChargedParty *v));

void BDecChargedPartyContent PROTO ((BUF_TYPE b, AsnTag tagId0, AsnLen elmtLen0, ChargedParty *v, AsnLen *bytesDecoded, ENV_TYPE env));


void PrintChargedParty PROTO ((FILE* f, ChargedParty *v, unsigned short int indent));
void FreeChargedParty PROTO ((ChargedParty *v));
...
typedef struct MessagingEvent /* [APPLICATION 433] IMPLICIT SEQUENCE */
{
    MessagingEventService* messagingEventService; /* MessagingEventService OPTIONAL */
    struct ChargedParty* chargedParty; /* ChargedParty OPTIONAL */
    RapFileSequenceNumber rapFileSequenceNumber; /* RapFileSequenceNumber OPTIONAL */
    SimToolkitIndicator simToolkitIndicator; /* SimToolkitIndicator OPTIONAL */
    struct GeographicalLocation* geographicalLocation; /* GeographicalLocation OPTIONAL */
    EventReference eventReference; /* EventReference OPTIONAL */
    RecEntityCodeList* recEntityCodeList; /* RecEntityCodeList OPTIONAL */
    NetworkElementList* networkElementList; /* NetworkElementList OPTIONAL */
    LocationArea* locationArea; /* LocationArea OPTIONAL */
    CellId* cellId; /* CellId OPTIONAL */
    ServiceStartTimestamp* serviceStartTimestamp; /* ServiceStartTimestamp OPTIONAL */
    struct NonChargedParty* nonChargedParty; /* NonChargedParty OPTIONAL */
    ExchangeRateCode* exchangeRateCode; /* ExchangeRateCode OPTIONAL */
    struct CallTypeGroup* callTypeGroup; /* CallTypeGroup OPTIONAL */
    Charge* charge; /* Charge OPTIONAL */
    TaxInformationList* taxInformationList; /* TaxInformationList OPTIONAL */
    OperatorSpecInfoList* operatorSpecInformation; /* OperatorSpecInfoList OPTIONAL */
} MessagingEvent;

AsnLen BEncMessagingEventContent PROTO ((BUF_TYPE b, MessagingEvent *v));

void BDecMessagingEventContent PROTO ((BUF_TYPE b, AsnTag tagId0, AsnLen elmtLen0, MessagingEvent *v, AsnLen *bytesDecoded, ENV_TYPE env));


void PrintMessagingEvent PROTO ((FILE* f, MessagingEvent *v, unsigned short int indent));
void FreeMessagingEvent PROTO ((MessagingEvent *v));
...
typedef struct SessionChargeInformation /* [APPLICATION 449] IMPLICIT SEQUENCE */
{
    ChargedItem chargedItem; /* ChargedItem OPTIONAL */
    ExchangeRateCode* exchangeRateCode; /* ExchangeRateCode OPTIONAL */
    struct CallTypeGroup* callTypeGroup; /* CallTypeGroup OPTIONAL */
...
AsnLen BEncSessionChargeInformationContent PROTO ((BUF_TYPE b, SessionChargeInformation *v));

void BDecSessionChargeInformationContent PROTO ((BUF_TYPE b, AsnTag tagId0, AsnLen elmtLen0, SessionChargeInformation *v, AsnLen *bytesDecoded, ENV_TYPE env));


void PrintSessionChargeInformation PROTO ((FILE* f, SessionChargeInformation *v, unsigned short int indent));
void FreeSessionChargeInformation PROTO ((SessionChargeInformation *v));
...
typedef AsnList SessionChargeInfoList; /* [APPLICATION 448] IMPLICIT SEQUENCE OF SessionChargeInformation */

AsnLen BEncSessionChargeInfoListContent PROTO ((BUF_TYPE b, SessionChargeInfoList *v));

void BDecSessionChargeInfoListContent PROTO ((BUF_TYPE b, AsnTag tagId0, AsnLen elmtLen0, SessionChargeInfoList *v, AsnLen *bytesDecoded, ENV_TYPE env));


void PrintSessionChargeInfoList PROTO ((FILE* f, SessionChargeInfoList *v, unsigned short int indent));
void FreeSessionChargeInfoList PROTO ((SessionChargeInfoList *v));
...
typedef struct MobileSession /* [APPLICATION 434] IMPLICIT SEQUENCE */
{
    MobileSessionService* mobileSessionService; /* MobileSessionService OPTIONAL */
    struct ChargedParty* chargedParty; /* ChargedParty OPTIONAL */
    RapFileSequenceNumber rapFileSequenceNumber; /* RapFileSequenceNumber OPTIONAL */
    SimToolkitIndicator simToolkitIndicator; /* SimToolkitIndicator OPTIONAL */
    struct GeographicalLocation* geographicalLocation; /* GeographicalLocation OPTIONAL */
    ...
    TotalCallEventDuration* totalCallEventDuration; /* TotalCallEventDuration OPTIONAL */
    struct NonChargedParty* nonChargedParty; /* NonChargedParty OPTIONAL */
    SessionChargeInfoList* sessionChargeInfoList; /* SessionChargeInfoList OPTIONAL */
    OperatorSpecInfoList* operatorSpecInformation; /* OperatorSpecInfoList OPTIONAL */
} MobileSession;

AsnLen BEncMobileSessionContent PROTO ((BUF_TYPE b, MobileSession *v));

void BDecMobileSessionContent PROTO ((BUF_TYPE b, AsnTag tagId0, AsnLen elmtLen0, MobileSession *v, AsnLen *bytesDecoded, ENV_TYPE env));


void PrintMobileSession PROTO ((FILE* f, MobileSession *v, unsigned short int indent));
void FreeMobileSession PROTO ((MobileSession *v));
...
typedef struct CallEventDetail /* CHOICE */
{
    enum CallEventDetailChoiceId
    {
        ...
        CALLEVENTDETAIL_MESSAGINGEVENT,
        CALLEVENTDETAIL_MOBILESESSION
    } choiceId;
    ...
    struct MessagingEvent* messagingEvent; /* MessagingEvent */
    struct MobileSession* mobileSession; /* MobileSession */
    } a;
} CallEventDetail;
...
#endif /* conditional include of tap312.h */
